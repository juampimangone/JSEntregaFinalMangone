document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    function confirmarCompra() {
        ...
        if (carrito.length > 0){
                    Swal.fire({
                    title: 'Estas seguro/a que quieres realizar esta compra?',
                    ...
                    cancelButtonText: 'Prefiero seguir viendo el catálogo !'
                    }).then((result) => {
                        if (result.isConfirmed) {
                            Swal.fire({
                                title: 'Compra realizada con éxito !',
                                text: "Esperemos verte nuevamente muy pronto !",
                                icon: 'success',
                                confirmButtonColor: '#008000',
                                confirmButtonText: 'Volveré !'
                                }).then((result) => {
                                    if (result.isConfirmed) {
                                        vaciarCarrito();
                                        }
            ...
            Swal.fire({
                title: 'Error',
                text: "Por favor ! Seleccione sus productos antes de confirmar su compra !",
                icon: 'error',
